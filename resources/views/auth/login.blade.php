...
<div id="maincontainer">
  <section id="product">
    <div class="container">
      ...
      <div class="row">  
        <div class="span9">
          <h1 class="heading1"><span class="maintext">S'identifier</span><span class="subtext">Première Connectez-vous ici pour voir toutes les informations de votre compte</span></h1>
          <section class="newcustomer">
            <h2 class="heading2">Nouveau Client </h2>
            <div class="loginbox">

              <p>En créant un compte, vous pourrez commander plus vite, d'être à jour sur le statut de l'ordre, et de garder trace des commandes que vous avez déjà faites.</p>
              <br>
          ...
          <section class="returncustomer">
            <h2 class="heading2">Déjà Client </h2>
            <div class="loginbox">
